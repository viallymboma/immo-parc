  ...
  theme: {
  	...
  	extend: {
  		...
  		animation: {
  			...
  			scrollPause: 'scrollPause linear infinite',
  			scrollPauseTimer: 'scrollPauseTimer 11s linear infinite',
  			scrollIncrement: 'scrollIncrement 10s linear infinite',
  			continuousScroll: 'continuousScroll 300s linear infinite',
